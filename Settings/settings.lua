...
-- @version 1.1
-- @provides
--   [linux-aarch64] reaper_gutilitiesapi-aarch64.so https://github.com/gu-on/GUtilitiesAPI/releases/download/v0.1/reaper_gutilitiesapi-aarch64.so
...
--   [linux32] reaper_gutilitiesapi-i686.so https://github.com/gu-on/GUtilitiesAPI/releases/download/v0.1/reaper_gutilitiesapi-i686.so
--   [win64] reaper_gutilitiesapi-x64.dll https://github.com/gu-on/GUtilitiesAPI/releases/download/v0.1/reaper_gutilitiesapi-x64.dll
--   [win32] reaper_gutilitiesapi-x86.dll https://github.com/gu-on/GUtilitiesAPI/releases/download/v0.1/reaper_gutilitiesapi-x86.dll
--   [nomain]../Include/lib.lua
--   [nomain]../Include/lib2.lua
-- @changelog
--   Update to include external plugins
-- @about
--   This script sets some settings

reaper.ShowConsoleMsg("Applying some settings\n")
